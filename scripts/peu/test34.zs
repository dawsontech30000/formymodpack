...
mods.pneumaticcraft.pressurechamber.addRecipe([<pneumaticcraft:plastic:11> * 14, <ore:ingotRedAlloy> * 14, <ore:pcb> *14, <opencomputers:material:4> *14, <opencomputers:material:9> *14], 3.0, [<pneumaticcraft:advanced_pcb>]);
