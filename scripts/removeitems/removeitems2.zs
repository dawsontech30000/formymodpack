...
recipes.removeShapeless(<redstonearsenal:armor.helmet_flux>, [<redstonearsenal:armor.helmet_flux>, <nuclearcraft:rad_shielding:2>]);
recipes.removeShapeless(<redstonearsenal:armor.helmet_flux>, [<redstonearsenal:armor.helmet_flux>, <nuclearcraft:rad_shielding:1>]);
